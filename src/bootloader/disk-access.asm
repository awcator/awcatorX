...
;mov dl, someDriveNumber, when i boot from qemu as single disk, bios automatically loads up my drive number at dl. ill just make sue of the same. 0x80 was my DL
